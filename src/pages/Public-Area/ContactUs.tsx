...
const ContactUs = (): JSX.Element => {
  return (
    <div className="main">
      <section
        className="page-header-section ptb-100 gradient-overly-right"
        style={{
          background:
            'url(/assets/img/hero-14.jpg)no-repeat center center / cover',
        }}
      >
          ...
          <div className="row">
                ...
                <div className="card-body py-5">
                  ...
                  <div>
                    ...
                    <p className="text-muted mb-0">
                      <span dir="ltr">{siteConfig.companyPhone}</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="card single-promo-card single-promo-hover text-center">
                <div className="card-body py-5">
                  <div className="pb-2">
                    <span className="ti-location-pin icon-sm color-primary" />
                  </div>
                  <div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="card single-promo-card single-promo-hover text-center">
                <div className="card-body py-5">
                  <div className="pb-2">
                    <span className="ti-headphone-alt icon-sm color-primary" />
                  </div>
                  <div>
            ...
            <div className="col-md-12">
              <div className="contact-us-content">
                ...
                <a href="#" className="btn outline-btn align-items-center">
                  دریافت <span className="ti-arrow-left pl-2" />
                </a>
                <hr className="my-5" />
                <h5>دفتر مرکزی ما</h5>
                ...
                <br />
                <span>
                  تلفن: <span dir="ltr">{siteConfig.companyPhone}</span>
                </span>{' '}
                <br />
                <span>
                  ایمیل{' '}
                  <a href="mailto:info@mrdomain.ir" className="link-color">
