        ...
        <Container>
          <div className="col-md-12 col-lg-12">
            <div className="cta-new-wrap">
              ...
              <h5>
                <span className="ti-control-backward mr-2 color-primary" />
                به علت تعداد دامنه های زیاد این شرکت پروسه تحویل کد انتقال در
                مواردی بین ۱ تا ۲ روز کاری زمان می برد و پروسه انتقال مالکیت هم
                بعد از آن تا ۳ روز کاری زمان لازم دارد
              </h5>
              <h5>
                <span className="ti-control-backward mr-2 color-primary" />
