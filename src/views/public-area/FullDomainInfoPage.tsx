        ...
        <Container>
          <div className="col-md-12 col-lg-12">
            <div className="cta-new-wrap">
              ...
              <h5>
                <span className="ti-control-backward mr-2 color-primary" />
                پروسه تحویل کد انتقال بعد از واریز هزینه دامنه بصورت کامل در
                لحظه و برخط تحویل مشتری می گردد و پروسه انتقال دامنه و تغییر
                مالکیت در لحضه و برخط انجام می شود.
              </h5>
              <h5>
                <span className="ti-control-backward mr-2 color-primary" />
