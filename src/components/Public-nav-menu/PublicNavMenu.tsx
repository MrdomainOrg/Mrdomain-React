          ...
          <div id="navBar" className="collapse navbar-collapse">
            <ul className="navbar-nav ml-auto main-navbar-nav">
              ...
              <li className="nav-item hs-has-sub-menu custom-nav-item">
                ...
                <ul
                  id="pagesSubMenu"
                  className="hs-sub-menu main-sub-menu"
                  aria-labelledby="pagesMegaMenu"
                  style={{ minWidth: '260px' }}
                >
                  <li className="nav-item submenu-item">
                    <a
                      className="nav-link sub-menu-nav-link"
              ...
              >
                ...
                <div
                  className="hs-mega-menu w-100 main-sub-menu"
              ...
              >
                ...
                >
                  <div className="title-with-icon-item">
                    <Link className="title-with-icon-link" to="/contactUs">
                      تماس باما
                      <div className="media align-items-center">
                        <img
                          className="menu-titile-icon"
                        ...
                        <div className="media-body">
                          ...
                          <small className="u-header__promo-text">
                            اگه مشکلی دارید باما تماس بگیرید
                          </small>
                        </div>
                      </div>
                    </Link>
                    ...
                    <a className="title-with-icon-link" href="#">
                      <div className="media align-items-center">
                        ...
                        <div className="media-body">
                          ...
                          <small className="u-header__promo-text">
                            ما شرکای قابل اعتمادی در سطح جهانی داریم
                          </small>
                        </div>
                      </div>
                    </a>
                  ...
                  <div className="title-with-icon-item">
                    <a className="title-with-icon-link" href="#">
                      <div className="media align-items-center">
                        ...
                        />
                        <div className="media-body">
                          <span className="u-header__promo-title">شبکه</span>{' '}
                          <small className="u-header__promo-text">
                  ...
                  <div className="title-with-icon-item">
                    <a className="title-with-icon-link" href="#">
                      <div className="media align-items-center">
                        ...
                        />
                        <div className="media-body">
                          <span className="u-header__promo-title">بلاگ</span>{' '}
                          <small className="u-header__promo-text">
                            آخرین اخبار شرکت
                          </small>
                        </div>
